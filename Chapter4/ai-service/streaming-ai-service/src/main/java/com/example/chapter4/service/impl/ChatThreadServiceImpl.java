...
public class ChatThreadServiceImpl implements ChatThreadService {
    ...
    public List<ChatThread> getAllThreads(String userName) {
        return chatThreadsRepository.findByUserName(userName);
    }
    ...
    @Override
    public ChatMessage saveMessage(String threadId, ChatMessage chatMessage, String userName) {
