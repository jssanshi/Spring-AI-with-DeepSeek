              ...
              <ThreadListPrimitive.Root className="flex flex-col items-stretch gap-1.5 h-full dark:text-white">
                <ThreadListPrimitive.New asChild>
                  ...
                  >
                    ...
                    <GithubButton url="https://github.com/mem0ai/mem0/tree/main/examples" className="w-full rounded-lg h-9 pl-2 text-sm font-semibold bg-zinc-800 dark:border-zinc-800 dark:text-white text-white hover:bg-zinc-900" text="Github" />
                  </div>
        ...
        <div className="flex w-full flex-grow flex-col items-center justify-start">
          <div className="flex flex-col items-center justify-center h-full">
            <div className="text-[2rem] leading-[1] tracking-[-0.02em] md:text-4xl font-bold text-[#1e293b] dark:text-white mb-2 text-center md:w-full w-5/6">
              ChatBot - DeepSeek with Spring AI
            </div>
...
const AssistantMessage: FC = () => {
  ...
  const hasReasoning = React.useMemo(() => {
    if (!Array.isArray(content)) return false;
    return content.some((item) => item.type === "reasoning");
  }, [content]);
